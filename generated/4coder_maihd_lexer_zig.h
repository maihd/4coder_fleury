...
TokenZigKind_Error = 130,
TokenZigKind_ErrDefer = 131,
TokenZigKind_Continue = 132,
TokenZigKind_Unreachable = 133,
TokenZigKind_Do = 134,
TokenZigKind_Else = 135,
TokenZigKind_For = 136,
TokenZigKind_Goto = 137,
TokenZigKind_If = 138,
TokenZigKind_Return = 139,
TokenZigKind_Switch = 140,
TokenZigKind_Try = 141,
TokenZigKind_While = 142,
...
TokenZigKind_AnyFrame = 161,
TokenZigKind_AnyOpaque = 162,
TokenZigKind_CallConvention = 163,
TokenZigKind_AddrSpace = 164,
TokenZigKind_AllowZero = 165,
TokenZigKind_Asm = 166,
TokenZigKind_Async = 167,
TokenZigKind_Await = 168,
TokenZigKind_Catch = 169,
TokenZigKind_NoAlias = 170,
TokenZigKind_NoInline = 171,
TokenZigKind_NoSuspend = 172,
TokenZigKind_LinkSection = 173,
TokenZigKind_OrElse = 174,
TokenZigKind_Packed = 175,
TokenZigKind_Resume = 176,
TokenZigKind_Suspend = 177,
TokenZigKind_Test = 178,
TokenZigKind_Var = 179,
TokenZigKind_Volatile = 180,
TokenZigKind_LiteralTrue = 181,
TokenZigKind_LiteralFalse = 182,
TokenZigKind_Identifier = 183,
TokenZigKind_PPInclude = 184,
TokenZigKind_PPVersion = 185,
TokenZigKind_PPDefine = 186,
TokenZigKind_PPUndef = 187,
TokenZigKind_PPIf = 188,
TokenZigKind_PPIfDef = 189,
TokenZigKind_PPIfNDef = 190,
TokenZigKind_PPElse = 191,
TokenZigKind_PPElIf = 192,
TokenZigKind_PPEndIf = 193,
TokenZigKind_PPError = 194,
TokenZigKind_PPImport = 195,
TokenZigKind_PPUsing = 196,
TokenZigKind_PPLine = 197,
TokenZigKind_PPPragma = 198,
TokenZigKind_PPUnknown = 199,
TokenZigKind_PPDefined = 200,
TokenZigKind_COUNT = 201,
};
